      ...
      let messageArea = $("#messageArea").hide();
        ...
        $("#fullName").on("blur", function()
        {
          ...
          else
          {
            ...
            messageArea.show().addClass("alert alert-danger").text("Please enter an appropriate Name.A first and last name is required(Minimum lenght of two characters each)!");
          }
/* 
